const pl = {
    ...
    "virtualMachine": {
        ...
        "form": {
            ...
            "excessiveMemorySelectionWarning": "Chcesz zadeklarować więcej niż 40% dostępnej pamięci operacyjnej. Może to spowodować spowolnienie działania systemu gospodarza lub innych maszyn wirtualnych.",
            "nameIsEmptyValidationError": "Nazwa nie może być pusta",
            "virtualCpuNotSetValidationError": "Musisz wybrać przynajmniej jedno wirtualne CPU",
