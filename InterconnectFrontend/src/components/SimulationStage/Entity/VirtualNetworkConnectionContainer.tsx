...
const VirtualNetworkConnectionContainer = ({ virtualNetworkEntity }: VirtualNetworkConnectionContainerProps) => {
    const sourceEntityPosition = useEntityPosition(virtualNetworkEntity.sourceEntityId, virtualNetworkEntity.sourceEntityType);
    const destinationEntityPosition = useEntityPosition(virtualNetworkEntity.destinationEntityId, virtualNetworkEntity.destinationEntityType);
    ...
    return (sourcePosition && destinationPosition) &&
        <VirtualNetworkConnection visible sourcePosition={sourcePosition} destinationPosition={destinationPosition} />;
};
