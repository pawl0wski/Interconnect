...
const VirtualCPUsSliderContainer = ({ virtualCPUs, error, onVirtualCPUsChange }: VirtualCPUsSliderProps) => {
    ...
    const handleChangeCpu = useCallback((virtualCpus: number) => {
