    ...
    return <div>
        ...
        <Flex direction="row" align="center" gap={10}>
            ...
            <Box style={{ flex: "0 0 25%" }}>
                <Input value={memoryInput} onChange={(e) => changeSelectedMemoryUsingInput(e.target.value)} />
            </Box>
        </Flex>
        {error && <InputError>{error}</InputError>}
        {showSafeMemoryWarning && <InputWarning text={t("virtualMachine.form.excessiveMemorySelectionWarning")} />}
    </div>;
};
