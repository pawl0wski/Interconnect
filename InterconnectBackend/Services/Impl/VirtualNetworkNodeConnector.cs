...
namespace Services.Impl
{
    public class VirtualNetworkNodeConnector : IVirtualNetworkNodeConnector
    {
        ...
        private readonly IVirtualNetworkNodeEntityRepository _switchRepository;
        ...
        public VirtualNetworkNodeConnector(
            IVirtualNetworkNodeEntityRepository switchRepository,
        ...
        {
            var sourceVirtualNetworkNodeEntities = await GetAllConnectedEntitiesToSwitch(sourceVirtualNetworkNode, null);
            var destinationVirtualNetworkNodeEntities = await GetAllConnectedEntitiesToSwitch(destinationVirtualNetworkNode, null);
        ...
        {
            var firstVirtualNetworkNodeEntities = await GetAllConnectedEntitiesToSwitch(firstVirtualNetworkNodeId, connectionId);
            var secondVirtualNetworkNodeEntities = await GetAllConnectedEntitiesToSwitch(secondVirtualNetworkNode, connectionId);
        ...
        {
            var virtualNetworkNodeConnectedEntities = await GetAllConnectedEntitiesToSwitch(virtualNetworkNodeId, null);
        ...
        {
            var virtualNetworkNodeConnectedEntities = await GetAllConnectedEntitiesToSwitch(virtualNetworkNodeId, connectionId);
        ...
        private async Task<List<EntityTypeWithId>> GetAllConnectedEntitiesToSwitch(int virtualNetworkNodeId, int? connectionIdToSkip)
        {
            var virtualNetworkNode = VirtualNetworkNodeEntityMapper.MapToDTO(await _switchRepository.GetById(virtualNetworkNodeId));
